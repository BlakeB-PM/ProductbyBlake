  ...
  return (
    <section className="pt-20 pb-16 sm:pt-24 sm:pb-20 md:min-h-screen md:flex md:items-center md:justify-center relative overflow-hidden">
      ...
      <div className="section-container">
        {/* Top row: Headline + Photo side by side */}
        <div className="flex flex-row items-start justify-between gap-4 sm:gap-8 md:gap-16 mb-6 sm:mb-8">
          {/* Headline - Left side */}
          ...
          {/* Headshot - Right side */}
          <div className="flex-shrink-0 w-36 sm:w-48 md:w-64 lg:w-72 xl:w-80 animate-fade-in">
        ...
        <div className="max-w-2xl md:max-w-none">
          {/* Subheadline */}
          <p className="text-sm sm:text-lg md:text-xl text-ink-600 leading-relaxed mb-6 sm:mb-8 animate-slide-up animation-delay-100">
          ...
          {/* Stats row - horizontal across full width */}
