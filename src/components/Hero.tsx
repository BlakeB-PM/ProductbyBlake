  ...
  return (
    <section className="pt-24 pb-16 sm:pt-24 sm:pb-20 md:min-h-screen md:flex md:items-center md:justify-center relative overflow-hidden">
      ...
      <div className="section-container">
        <div className="block md:flex md:flex-row md:items-start md:justify-between md:gap-16">
          
          {/* Headshot - Float Right on mobile, Order 2 on desktop */}
          <div className="float-right ml-4 mb-2 md:float-none md:ml-0 md:mb-0 w-36 sm:w-48 md:w-64 lg:w-72 xl:w-80 md:order-2 animate-fade-in relative z-10">
          ...
          <div className="md:order-1 md:flex-1">
            ...
            {/* Main headline */}
            <h1 className="font-serif text-4xl xs:text-5xl sm:text-6xl lg:text-7xl font-medium leading-[1.1] text-ink-900 animate-slide-up break-words mb-4 sm:mb-6">
